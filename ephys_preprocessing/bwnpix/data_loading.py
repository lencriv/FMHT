...
cache_root = 'Z:/motiv/data/cache/'
behavior_path = 'Z:/motiv/data/npix_behavior/'
fig_path = 'Z:/motiv/data/figures/'
data_export_path = 'Z:/motiv/data/export/'
ephys_path = 'Z:/motiv/data/ephys/localProcessedData/'
...
def get_good_recordings(condition):
    ...
    both = [
          ...
          "mR2_20221211",
          "mR2_20221215",
    # #      "mR2_20230124", need behavior file for this session
    # #     "mR2_20230127", need behavior fie for this sesssion
    #     # "mR2_202207120", # PCP RECORDING
    #     # "mR2_202207121", # PCP RECORDING
          "mon3_20231201",
          "mon3_20231202",
          "mon5_20240328",
          "mon5_20240329",
    ...
    hungry = [
         "mR3_20220525",
         "mR3_20220527",
    #     #"mR2_20230112" no good units
    #     "mR2_20230113", #data does not have good units?
    #     #missing data? "mR2_20230111",
         "mon3_20231205",
         "mon3_20231206",
        "mon5_20240324",
        "mon5_20240323"
    ...
    thirsty = [
    #     #missing data "mR3_20220604",
          "mon3_20231208",
    #      "mR10_20221215", #behavior video for this file is truncated for some reason
          "mR3_20220606",
          "mR10_20221216",
          "mR2_20230116",
          "mR2_20230117",
    ...
    sated = [
        ...
        "mR10_20221213",
        "mR2_20230108",
        #"mR2_20230107", #need to fix unit number... saying no good units
        "mon3_20231204",
        "mon3_20231207",
        "mon3_20231212",
        "mon5_20240318",
...
def cache_data(recordings):
    ...
    for recording in recordings:
        ...
        path = f"Z:/motiv/data/ephys/localProcessedData/{mname}/catgt_{recording}_g0"
        print('loading' + path)
    ...
    for dataset in tqdm.tqdm(datasets):
        pathname = f"Z:/motiv/data/export/{'_'.join(dataset[:2])}.pkl"
...
def smooth_and_cache_fr(all_paths, smooth_size=5, save_dir='Z:/motiv/data/export/'):
    '''
